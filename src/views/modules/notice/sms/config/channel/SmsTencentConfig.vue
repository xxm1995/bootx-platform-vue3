    ...
    <a-spin :spinning="confirmLoading">
      ...
      >
        ...
        <a-form-item label="sdkAppId" name="sdkAppId">
          <a-input v-model:value="form.sdkAppId" :disabled="showable" placeholder="请输入短信sdkAppId" />
        </a-form-item>
        <a-form-item label="地域信息" name="territory">
          <a-input v-model:value="form.territory" :disabled="showable" placeholder="请输入短信地域信息" />
        </a-form-item>
        <a-form-item label="请求超时时间" name="connTimeout">
          <a-input-number v-model:value="form.connTimeout" :disabled="showable" placeholder="请输入短信请求超时时间" />
        </a-form-item>
        ...
        <a-form-item label="服务名" name="service">
          <a-input v-model:value="form.service" :disabled="showable" placeholder="请输入短信服务名" />
        </a-form-item>
...
<script setup lang="ts">
   ...
   */
  function handleOk() {
    form.code = smsChannelEnum.TENCENT
    form.name = '腾讯短信'
