    ...
    <a-spin :spinning="confirmLoading">
      ...
      >
        ...
        <a-form-item label="应用ID" name="appId">
          <a-input v-model:value="form.appId" :disabled="showable" placeholder="请输入短信应用ID" />
        </a-form-item>
        <a-form-item label="请求地址" name="baseUrl">
          <a-input v-model:value="form.baseUrl" :disabled="showable" placeholder="请输入短信请求地址baseUrl" />
        </a-form-item>
...
<script setup lang="ts">
   ...
   */
  function handleOk() {
    form.code = smsChannelEnum.CLOOPEN
    form.name = '容联短信'
